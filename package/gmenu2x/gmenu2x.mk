...
GMENU2X_CONF_OPT += -DSCREEN_WIDTH=$(BR2_PACKAGE_GMENU2X_WIDTH) -DSCREEN_HEIGHT=$(BR2_PACKAGE_GMENU2X_HEIGHT)
endif

ifneq ($(BR2_PACKAGE_GMENU2X_DEFAULT_FALLBACK_FONTS),"")
GMENU2X_CONF_OPT += -DDEFAULT_FALLBACK_FONTS=$(BR2_PACKAGE_GMENU2X_DEFAULT_FALLBACK_FONTS)
endif
