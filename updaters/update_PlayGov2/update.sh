...
export DIALOGOPTS="--colors --backtitle \"PLAYGOV2 ROGUE VERSION update\""

DISCLAIMER="\Zb\Z3ATTENTION\Zn

This update is \Zb\Z3ONLY\Zn for the \Zb\Z3PLAYGOV2\Zn,
it will \Zb\Z3not work\Zn on a \Zb\Z3PLAYGO\Zn model.

Are you sure your console is the \Zb\Z3PLAYGOV2\Zn?"
...
personal data on your PLAYGO v2 before you
perform the update.
...
if [ -f "$DATE_FILE" ] ; then
	...
	export DIALOGOPTS="--colors --backtitle \"PLAYGO V2 update $VERSION $DATE\""
fi
