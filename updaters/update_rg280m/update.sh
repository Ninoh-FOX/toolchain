...
export DIALOGOPTS="--colors --backtitle \"RG280M ROGUE VERSION update\""

DISCLAIMER="\Zb\Z3ATTENTION\Zn

This update is \Zb\Z3ONLY\Zn for the \Zb\Z3RG280M\Zn,
it will \Zb\Z3not work\Zn on a \Zb\Z3RG350\Zn or
\Zb\Z3RG280V\Zn model.

Are you sure your console is the \Zb\Z3RG280M\Zn?"
...
personal data on your RG280M before you
perform the update.
...
if [ -f "$DATE_FILE" ] ; then
	...
	export DIALOGOPTS="--colors --backtitle \"RG280M ROGUE VERSION update $DATE $VERSION\""
fi
