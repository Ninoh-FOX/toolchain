...
export DIALOGOPTS="--colors --backtitle \"RG300X ROGUE VERSION update\""

DISCLAIMER="\Zb\Z3ATTENTION\Zn

This update is \Zb\Z3ONLY\Zn for the \Zb\Z3RG300X\Zn,
it will \Zb\Z3not work\Zn on a \Zb\Z3RG350/M\Zn model.

Are you sure your console is the \Zb\Z3RG300X\Zn?"
...
personal data on your RG-300X before you
perform the update.
...
if [ -f "$DATE_FILE" ] ; then
	...
	export DIALOGOPTS="--colors --backtitle \"RG300X ROGUE VERSION update $DATE $VERSION\""
fi
