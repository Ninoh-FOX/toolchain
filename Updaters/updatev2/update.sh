...
export DIALOGOPTS="--colors --backtitle \"PG2V2 ROGUE VERSION update\""

DISCLAIMER="\Zb\Z3ATTENTION\Zn

This update is \Zb\Z3ONLY\Zn for the \Zb\Z3PG2V2\Zn,
it will \Zb\Z3not work\Zn on a \Zb\Z3PG2\Zn model.

Are you sure your console is the \Zb\Z3PG2V2\Zn?"
...
personal data on your POCKETGO2 v2 before you
perform the update.
...
if [ -f "$DATE_FILE" ] ; then
	...
	export DIALOGOPTS="--colors --backtitle \"POCKETGO2 V2 update $VERSION $DATE\""
fi
